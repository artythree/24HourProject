    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Posts", t => t.CommentPost_PostId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Posts", t => t.LikedPost_PostId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Likes", "LikedPost_PostId", "dbo.Posts");
            DropForeignKey("dbo.Comments", "ReplyComment_CommentId", "dbo.Comments");
            DropForeignKey("dbo.Comments", "CommentPost_PostId", "dbo.Posts");
            ...
            DropIndex("dbo.Likes", new[] { "LikedPost_PostId" });
            DropIndex("dbo.Comments", new[] { "ReplyComment_CommentId" });
            DropIndex("dbo.Comments", new[] { "CommentPost_PostId" });
